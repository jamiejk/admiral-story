...
const galleryImages: GalleryImage[] = [
  {
    ...
    caption: 'The studio roof completely collapsed under the weight of the 44-tonne tree.',
    category: 'damage',
  },
  {
    id: 2,
    ...
    caption: 'Massive branches pierced entirely through the roof and walls.',
    category: 'damage',
  },
  {
    id: 3,
    ...
    caption: 'The internal devastation: studio equipment buried under rubble and timber.',
    category: 'damage',
  },
  {
    id: 4,
    src: '/photos/PXL_20241209_143140468_RAW-01_COVER__1_.webp',
    alt: 'Another internal view of the destroyed studio',
    caption: 'More internal devastation, showing the scale of the ceiling collapse.',
    category: 'damage',
  },
  {
    id: 5,
    ...
    caption: 'The ruin of what was, merely five weeks prior, a newly renovated space.',
    category: 'damage',
  },
  {
    id: 6,
    ...
    caption: 'The 28-meter tree resting entirely on the compromised structure.',
    category: 'damage',
  },
  {
    id: 7,
    ...
    caption: 'The site after tree removal, showing the dangerous, shifting remains of the structure.',
    category: 'aftermath',
  },
  {
    id: 8,
    ...
    caption: 'The impact also caused damage to the main house, which Admiral has systematically ignored.',
    category: 'aftermath',
  },
  {
    id: 9,
    ...
    caption: 'Close-up of the shattered Bison beams and failed load-bearing components.',
    category: 'aftermath',
  },
  {
    id: 10,
