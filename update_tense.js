...
const replacements = [
    ...
    ['Duffy offers contingency sum only if I agree to lower base settlement. Rejected as "used car salesman"', 'Duffy offers contingency sum only if I agree to lower base settlement. Rejects as "used car salesman"'],
