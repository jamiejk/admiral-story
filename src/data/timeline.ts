...
export const defaultTimelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    category: 'payment',
    fullDetails: 'Without prior notice or the conclusion of scope negotiations, Admiral unilaterally issues a payment of £33,790 into my bank account. For reference, this figure is lower than the original construction cost of the building almost a decade ago.\n\nThis settlement is based exclusively on a "desktop" Scope of Works created by GSP (Gately-Smithers-Purslow). No representative from GSP visited the property to verify the structural damage prior to the creation of this document.\n\nAlthought it is called an \'interim\' payment, the settlement effectively forces me down the \'cash\' route, relies on a reinstatement plan that overlooks critical findings from the independent, RICS-qualified surveyor and fails to provide the funds necessary for a safe and complete repair as required by the policy terms.',
    isKey: true,
  },
  {
    id: 30,
